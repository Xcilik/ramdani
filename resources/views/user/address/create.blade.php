        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 tracking-tight">
                    {{ isset($address) ? 'Update Address' : 'New Address' }}
                </h1>
                <p class="text-sm text-gray-500 mt-2">
                    {{ isset($address) ? 'Edit your existing shipping details below.' : 'Add a new destination for your orders.' }}
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 p-8 overflow-hidden relative">
                ...
                <div class="absolute top-0 right-0 w-32 h-32 bg-indigo-50 rounded-bl-full opacity-50 -mr-10 -mt-10 pointer-events-none"></div>
                ...
                <form action="{{ isset($address) ? route('user.addresses.update', $address->id) : route('user.addresses.store') }}" method="POST">
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4 border-b border-gray-50 pb-2">01. Receiver Details</h3>
                        ...
                        {{-- SECTION 2: LOCATION --}}
                        <div>
                            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4 border-b border-gray-50 pb-2">02. Location</h3>
